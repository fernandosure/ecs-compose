...
class ServiceDefinition(object):
    def __init__(self, json_spec, defaults):
        ...
        self.elb = [ElbDefinition(elb) for elb in self.json.get("elb", [])]
...
class ElbDefinition(object):
    def __init__(self, json_spec):
        ...
        self.ports = ElbPortsDefinition(json_spec.get("ports"))
        self.dns = DnsDefinition(json_spec.get("dns"))
        self.certificates = [{"CertificateArn": x} for x in json_spec.get("certificates", [])]
        self.healthcheck = ElbHealthCheck(json_spec.get("healthcheck", {}))
...
class ElbPortsDefinition(object):
    def __init__(self, json_spec):
        self.public = json_spec.get("public")
        self.container = json_spec.get("container")


class DnsDefinition(object):
    def __init__(self, json_spec):
